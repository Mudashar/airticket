 ...
 */
		...
		function valid(){
				...
				var flname=document.forms["Registration"]["flname"].value;
				var femail=document.forms["Registration"]["femail"].value;
				var fpass=document.forms["Registration"]["fpass"].value;
				var fcpass=document.forms["Registration"]["fcpass"].value;

				 var vemail=/[a-zA-Z0-9._-]+[@]{1}[a-z]+[.]{1}[a-zA-Z]{3}$/;
				 
				 if(fname==""){
					alert("Enter first name");
					document.Registration.fname.focous();
					return false;
				 }
				 if(!(isNaN(fname))){
					alert(" name must consist of character:");
					document.Registration.fname.focous();
					return false;
				 }
				 if(flname==""){
					alert("Enter last name");
					document.Registration.flname.focous();
					return false;
				 }
				 if(!(isNaN(flname))){
					alert(" last name must consist of character:");
					document.Registration.flname.focous();
					return false;
				 }
				 ...
				 if(femail==""){
					alert("Enter email");
					document.Registration.femail.focous();
					return false;
				 }
				
				if(!(vemail.test(femail))){
					alert("incorrect email no:");
					document.Registration.femail.focous();
					return false;
				}
				 if(fpass==""){
					alert("Enter email");
					document.Registration.fpass.focous();
					return false;
				 }
				 if(fcpass==""){
					alert("Enter email");
					document.Registration.fcpass.focous();
					return false;
				 }
				 if(fpass!=fcpass){
